# FinWisely - Financial Advisor using Multi-Agent Systems
...
- **pandas-ta / ta**: Technical analysis indicators (the project prefers `pandas-ta`; code falls back to `ta` on Python 3.11+).
