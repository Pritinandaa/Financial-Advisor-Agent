...
class RedditSentimentAnalysisTool(BaseTool):
    ...
    # Define private attributes that won't interfere with BaseTool validation
    _tokenizer: AutoTokenizer = PrivateAttr()
    _model: AutoModelForSequenceClassification = PrivateAttr()
    ...
    def _run(self, stock_symbol: str, subreddits: list = ['wallstreetbets', 'stocks', 'investing'], limit: int = 100):
        """
